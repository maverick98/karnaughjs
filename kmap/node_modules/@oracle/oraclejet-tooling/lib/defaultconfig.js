...
module.exports = {
  build: {
    ...
    injectPaths: paths => ({
      ...
      destMainJs: `${paths.staging.stagingPath}/${paths.src.javascript}/bundle-temp.js`,
      destMainJsEs5: `${paths.staging.stagingPath}/${paths.src.javascript}/bundle-temp_es5.js`,
    }),
      ...
      fileList: [
        {
          ...
          src: ['**/*.js', `!${paths.composites}/**/*.js`, '!libs/**/*.js'],
        ...
        {
          cwd: `${paths.staging.stagingPath}/${paths.src.javascript}`,
          src: ['bundle-temp.js', 'bundle-temp_es5.js'],
          dest: `${paths.staging.stagingPath}/${paths.src.javascript}`
        },
        {
      ...
      fileList: [
        {
          ...
          src: [
            ...
            `!${paths.src.typescript}/${paths.composites}/**`,
            '!cordova.js'
          ],
    ...
    requireJs: paths => ({
      ...
      name: 'bundle-temp',
      optimize: 'none',
      out: `${paths.staging.stagingPath}/${paths.src.javascript}/bundle.js`
    }),
    requireJsEs5: paths => ({
      baseUrl: `${paths.staging.stagingPath}/${paths.src.javascript}`,
      name: 'bundle-temp_es5',
      optimize: 'none',
      out: `${paths.staging.stagingPath}/${paths.src.javascript}/bundle_es5.js`
    }),
    requireJsComponent: {
      optimize: 'none',
      separateCSS: false,
    ...
    sass: paths => ({
      fileList: [
        ...
        {
          cwd: `${paths.src.common}/${paths.src.typescript}/${paths.composites}`,
          src: ['**/*.scss', '!**/_*.scss'],
          dest: `${paths.staging.stagingPath}/${paths.src.typescript}/${paths.composites}`
        },
        {
          cwd: `${paths.components}`,
          src: ['**/*.scss', '!**/_*.scss'],
    ...
    pcss: paths => ({
      ...
      options: {
        sourceMap: false,
        includePaths: [
          `node_modules/@oracle/oraclejet/dist/pcss/oj/v${util.getJETVersion()}/`,
          `${paths.src.common}/${paths.src.javascript}/${paths.composites}`,
          `${paths.src.common}/${paths.src.typescript}/${paths.composites}`,
    ...
    watch: paths => ({
      ...
      sass: {
        files: [
          ...
          `${paths.src.common}/${paths.src.typescript}/${paths.composites}/**/*.scss`
        ],
        options: {
          livereload: true,
          spawn: false
